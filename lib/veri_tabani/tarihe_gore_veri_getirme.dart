              ...
              SliverList(delegate: SliverChildBuilderDelegate((context, index) {
                   return Card(
                    color: Colors.white60,
                      ...
                      subtitle: Text(widget.gunlukDers[index]['tarih'].toString(),style: TextStyle(color: Colors.black,fontFamily: 'ozelRoboto',fontSize: 15,fontWeight: FontWeight.bold),),
